...
function Order() {
  ...
  // Everyone ecan search for all orders, so for privacy reasons we're gonna gonna exclude names or address, these are only for the restaurant staff
...
export async function orderLoader({ params }) {
  // Simulate an API call to fetch order data
